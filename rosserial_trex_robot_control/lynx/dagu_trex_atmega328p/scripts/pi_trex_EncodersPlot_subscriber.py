...
class GraphFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        self.data = [encoderValues[0]]
        self.data2 = [encoderValues[1]]
    ...
    def UpdatePlot_Timer(self, event):
    	global encoderValues
        self.data.append(encoderValues[0])
        self.data2.append(encoderValues[1])
...
def trex_pi_EncPlotCb(data):
    global encoderValues
##    rospy.loginfo("Left Encoder: %f Right Encoder: %f", data.left_encoder, data.right_encoder)
    encoderValues[0] = data.left_encoder
    encoderValues[1] = data.right_encoder

def pi_trex_EncoderPlot_subscriber():
    rospy.init_node('pi_trex_EncoderPlot_subscriber', anonymous = True)
    rospy.Subscriber('trex_pi_rob_data__talkback', TrexRobotData, trex_pi_EncPlotCb)
    rospy.spin()
...
if __name__ == "__main__":
    try:
        ...
        app.frame.Show()        
        pi_trex_EncoderPlot_subscriber()
        app.MainLoop()
    except rospy.ROSInterruptException:
        rospy.loginfo('Interrupt Triggered')
        pass
